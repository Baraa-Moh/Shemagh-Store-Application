...
$user = $_SESSION['user'];
$orders = OrderData::getOrdersByUserId($user->getID());
...
<head>
    ...
    <title>شماغ الملوك - طلباتي</title>
        ...
        <div class="orders-container">
            <?php if(empty($orders)): ?>
                ...
                <div class="empty-orders">
                    ...
                    <p>ابدأ التسوق الآن واستمتع بأفضل الأشمغة</p>
                            ...
                            <div>
                                ...
                                <?php if($order->getStatus() === 'pending' || $order->getStatus() === 'processing'): ?>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <button type="submit" class="btn btn-secondary" onclick="return confirm('هل أنت متأكد من إلغاء الطلب؟')">إلغاء الطلب</button>
                                    </form>
                                <?php endif; ?>
                            </div>
                        </div>
